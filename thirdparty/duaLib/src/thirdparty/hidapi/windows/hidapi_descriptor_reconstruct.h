...
typedef struct hid_pp_cap_ {
	...
	BOOLEAN IsRange       : 1;
	BOOLEAN IsAlias       : 1;  // IsAlias is set to TRUE in the first n-1 capability structures added to the capability
								// array. IsAlias set to FALSE in the nth capability structure.
