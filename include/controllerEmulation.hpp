...
private:
	...
	static VOID CALLBACK xbox360Notification(PVIGEM_CLIENT Client,
											 PVIGEM_TARGET Target,
											 UCHAR LargeMotor,
											 UCHAR SmallMotor,
											 UCHAR LedNumber,
											 LPVOID UserData);
	static VOID CALLBACK ds4Notification(PVIGEM_CLIENT Client,
										 PVIGEM_TARGET Target,
										 UCHAR LargeMotor,
										 UCHAR SmallMotor,
	...
	static VOID CALLBACK x360PeerNotification(PVIGEM_CLIENT Client,
											  PVIGEM_TARGET Target,
											  UCHAR LargeMotor,
											  UCHAR SmallMotor,
											  UCHAR LedNumber,
											  LPVOID UserData);
	static VOID CALLBACK ds4PeerNotification(PVIGEM_CLIENT Client,
											 PVIGEM_TARGET Target,
											 UCHAR LargeMotor,
											 UCHAR SmallMotor,
											 DS4_LIGHTBAR_COLOR LightbarColor,
